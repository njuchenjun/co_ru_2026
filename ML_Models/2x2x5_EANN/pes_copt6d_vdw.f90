subroutine co_pt_pes(c,v,idv,dv)
  ...
  real*8,parameter :: vinf=-58.495d0
  ...
  call nnfit_c1(6,1,ctrans,v1,0,dvtrans);
  v=v1-vinf
  ...
  if(idv.eq.1) then
    ...
    do j=1,6
      ...
      call cart2frac(ctrans,frac)
      call frac2unit(frac,ctrans,zmat,2,0)
      call nnfit_c1(6,1,ctrans,vx,0,dvt); vx=vx-vinf

      ctrans=cy
      call cart2frac(ctrans,frac)
      call frac2unit(frac,ctrans,zmat,2,0)
      call nnfit_c1(6,1,ctrans,vy,0,dvt); vy=vy-vinf
...
! --------------------------------------------------------------------
subroutine nnfit_c1(ndim,ntot,r0,vx,idv,dv)
  implicit none
  ...
  character*99,save :: wfile="pes_copt6d_e17.txt"
