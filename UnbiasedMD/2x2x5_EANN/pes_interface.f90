subroutine pes_co36_pt6x6(x,e,dedx)
  implicit none
  real*8,intent(in) :: x(3,72)
  real*8,intent(out) :: e,dedx(3,72)

  real*8 :: c(3,2),v,dv(3,2)

  real*8 :: x0(3,72),xn(3,72)
...
subroutine move_to_6x6_cell(x,x0)
  implicit none
  real*8,parameter :: a0=2.812256750888d0
  integer,parameter :: ncell=6
  real*8,parameter :: a(3)=[a0*sqrt(3.d0)/2.d0,-a0/2.d0,0.d0]*ncell
